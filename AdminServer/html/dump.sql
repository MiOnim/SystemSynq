...
INSERT INTO `HardwareSoftware` VALUES ('1','Adams-203001','20%','4096MB','235520MB','5','malware.exe,badprocesses.exe'),('2','Adams-203002','35%','1024MB','234410MB','10','virus.exe,malicious.exe,ransomware.exe');
...
INSERT INTO `MachineInfo` VALUES ('1','Adams-203001','4','2.3GHz','8096MB','1048576MB','On');
...
INSERT INTO `users` VALUES ('admin','admin','all'),('hello','hi there','hello'),('test','$2y$10$kFV6z4PcwYgrqW6FgW2sk.cWjzcfEp4q6YpbI0TZBaenq/7flY6PG','test'),('another test','$2y$10$arwkPd0XIzZODROlTKrhOuNesn2uVYiNLFSOeqYguP/IlHMW35LBy','another test'),('one more test','$2y$10$anficB4eIf68asiaYsxkpu7sSQ6XcOs8buOgV.3FzsdyMQYP4g5xy','one more test'),('matt','$2y$10$Cn153R4U9QBD3mWdVzBH2O8tWTiJeGFqstxg6oajBCMfvCbH9IUKW','matt'),('bob','$2y$10$aASEz5kOJQ.Vv2rVu3HymehTe6FEyzR4EsVJlzmtfoHp7iTACC4rG','bob');
...
-- Dump completed on 2017-04-20 18:38:10
